...
# Set the COHERE_API_KEY environment variable to the value of your API key
os.environ["COHERE_API_KEY"] = "dpZVwktZYWPqSkv8VKkGYmDrodgBvwfJDSdD9vLT"
...
st.write( '')
st.markdown("Created by[Rawand Fatah](Facebook:Rawand Halabjay)")